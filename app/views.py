...
def do_order():
    ...
    flash('Для того - чтобы совершить заказ, вам необходимо выбрать все знаечния из выпадающего списка',category='success')
    if form.validate_on_submit():
        ...
        if form.submit2.__call__():
            o = Orders(order_name=form.order_name.data,phone=form.phone.data,adress=form.adress.data,dish1=form.dish1.data, dish2=form.dish2.data, dish3=form.dish3.data, dish4=form.dish4.data,
